...
slate.Variants = (function() {
    ...
    Variants.prototype = Object.assign({}, Variants.prototype, {
        ...
        _getCurrentOptions: function() {
            ...
            console.log("ANK 1 :: " + JSON.stringify(result));
        ...
        _getVariantFromOptions: function() {
            ...
            var found = variants.find(function(variant) {
                //console.log("ANK 2 :: "+JSON.stringify(variant));
                return selectedValues.every(function(values) {
                    //console.log("ANK 3 :: variant[values.index] = "+variant[values.index]+" || values.value = "+values.value);
...
theme.Drawers = (function() {
    ...
    Drawer.prototype.init = function() {
        if (document.querySelector(this.config.selectors.openVariant) != null) {
            document
...
theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
        ...
        _updateCartPopupContent: function(item) {
            ...
            console.log('_updateCartPopupContent');
        },
...
$(document).ready(function() {
    ...
    $("li.grid__item .product-card").each(function() {
